...
\begin{figure}[hbtp]
\centering
    \includegraphics[scale=.70]{kenel-machine-xor.png}
...
\begin{figure}[hbtp]
\centering
    \includegraphics[scale=.70]{L2VM-L1VM-RVM-SVM-2d.png}
...
If $L$ is quadratic loss, this is equivalent to ridge regression, and if $L$ is the log-loss defined in Equation \eqref{eqn:log-loss}, this is equivalent to logistic regression.
...
\begin{figure}[hbtp]
\centering
    \includegraphics[scale=.70]{choosing-C.png}
