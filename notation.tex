...
\noalign{\smallskip}\svhline\noalign{\smallskip}
$C$ & Number of classes\\
$M$ & Number of data cases\\
$M_c$ & Number of examples of class $c$,$M_c=\sum_{i=1}^{M}\mathbb{I}(y_i=c)$\\
$N$ & Dimensionality of data vector (number of features)\\
$R$ & Number of outputs (response variables)\\
$\mathcal{D}$ & Training data $\mathcal{D}=\left\{(\vec{x}_i,y_i) | i=1:M\right\}$\\
