...
\begin{figure}[hbtp]
\centering
    \includegraphics[scale=.70]{Empirical-predictive-distribution.png}
...
\begin{figure}[hbtp]
\centering
    \includegraphics[scale=.60]{posterior1.png}
...
\begin{figure}[hbtp]
\centering
    \includegraphics[scale=.60]{posterior2.png}
...
\begin{figure}[hbtp]
\centering
    \includegraphics[scale=.70]{posterior-predictive-distribution.png}
...
\begin{figure}[hbtp]
\centering
    \includegraphics[scale=.50]{beta-binomial-distribution.png}
